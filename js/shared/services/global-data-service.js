(function(window, angular) {
    'use strict';
    // create a global data service that provides a store and a shopping cart that will be shared by all
    angular.module('shoppingKartApp.shared.services').factory('GlobalDataService', ['$rootScope', 'shoppingCart', 'product',
        function($rootScope, shoppingCart, product) {
